...
const SearchResultHeader = () => {
    ...
    return (
        <div className="flex p-[15px] pb-0 md:pr-5 md:pl-20 md:pt-7 border-b 
        border-[#ebebeb]  md:block flex-col items-center sticky top-0 bg-white ">
            ...
            <div className="flex ml-[-12px] mt-3">
                  {menu.map((menu,index)=>(
                    <span key={index} className={`flex items-center p-3 text-[#5f6368]
